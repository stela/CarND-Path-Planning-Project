    ...
    if (length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (!s.empty()) {
        ...
        if (event == "telemetry") {
            ...
            double car_s = j[1]["s"];
            double car_d = j[1]["d"];
            double car_yaw = j[1]["yaw"];  // yaw as degrees
            ...
            // First two dots connect to where the car is now and where it's headed
            if (prev_size < 2)
            {
                // points tangent to the car
            ...
            {
                // shift car to origin of coordinate system
            ...
            // reuse left-over previous path coordinates
            ...
            // splits up spline points into intervals to reach the desired speed
            ...
            for (int i = 1; i <= 50-previous_path_x.size(); i++) {
                ...
                // reverse earlier coordinate transformation
